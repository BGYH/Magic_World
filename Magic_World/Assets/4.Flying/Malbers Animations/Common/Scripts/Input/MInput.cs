...
namespace MalbersAnimations
{
    ...
    public class MInput : MonoBehaviour, IInputSource , IAnimatorListener
    {
        ...
        //oculus Fly
        [ContextMenu("Create/Fly2")]
        private void CreateFlyInput2()
        {
            inputs.Add(new InputRow(true, "Fly2", "Fly2", KeyCode.Q, InputButton.Toggle, InputType.Key));
            MTools.SetDirty(this);
        }
